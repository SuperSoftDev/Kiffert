...
class IndexView(TemplateView):
	...
	def get(self,request):
		...
		return render(self.request,"reports/index.html",context)sssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss